...
public class UIConstants {
    ...
    public static final Color PRIMARY_COLOR = new Color(230, 57, 70); // #E63946
    public static final Color SECONDARY_COLOR = new Color(168, 218, 220); // #A8DADC
    public static final Color HEADING_COLOR = new Color(29, 53, 87); // #1D3557
    public static final Color WHITE_COLOR = new Color(255, 255, 255);
    public static final Color SECTION_BG_COLOR = new Color(236, 236, 236); // #ececec
